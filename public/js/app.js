...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lang_locales_js__ = __webpack_require__(15);
...
var i18n = new __WEBPACK_IMPORTED_MODULE_2_vue_i18n__["a" /* default */]({
  ...
  fallbackLocale: 'en',
  messages: __WEBPACK_IMPORTED_MODULE_0__lang_locales_js__["a" /* default */]
});

/**
 * Laravel Passport
 */
__WEBPACK_IMPORTED_MODULE_1_vue___default.a.component('passport-clients', __webpack_require__(41));

__WEBPACK_IMPORTED_MODULE_1_vue___default.a.component('passport-authorized-clients', __webpack_require__(47));

__WEBPACK_IMPORTED_MODULE_1_vue___default.a.component('passport-personal-access-tokens', __webpack_require__(52));

__WEBPACK_IMPORTED_MODULE_1_vue___default.a.component('cookie-law', __webpack_require__(57));
...
var update = __webpack_require__(2)("1910abc0", content, false);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("090f17ba", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("30e08c62", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("3e8056b3", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
var Component = {
    ...
    _getCookiesInstance: function _getCookiesInstance() {
        return __WEBPACK_IMPORTED_MODULE_0_js_cookie___default.a;
    },
    data: function data() {
        return {
            isOpen: false
