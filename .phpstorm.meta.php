    ...
    */
    $STATIC_METHOD_TYPES = [
        new \Illuminate\Contracts\Container\Container => [
            ...
            'user.menu' instanceof \Gzero\Core\Menu\Register,
            'block:type:basic' instanceof \Gzero\Core\Handler\Block\Basic,
            'block:type:content' instanceof \Gzero\Core\Handler\Block\Content,
            'block:type:menu' instanceof \Gzero\Core\Handler\Block\Menu,
            'block:type:slider' instanceof \Gzero\Core\Handler\Block\Slider,
            'block:type:widget' instanceof \Gzero\Core\Handler\Block\Widget,
            'content:type:content' instanceof \Gzero\Core\Handler\Content\Content,
            'content:type:category' instanceof \Gzero\Core\Handler\Content\Category,
            'file:type:image' instanceof \Gzero\Core\Handler\File\Image,
            'file:type:document' instanceof \Gzero\Core\Handler\File\Document,
            'file:type:video' instanceof \Gzero\Core\Handler\File\Video,
            'file:type:music' instanceof \Gzero\Core\Handler\File\Music,
            'command.mysqldump' instanceof \Gzero\Core\Commands\MysqlDump,
            'command.mysqlrestore' instanceof \Gzero\Core\Commands\MysqlRestore,
            ...
            'admin.module' instanceof \Gzero\Admin\ModuleRegistry,
